/**
 * Teaching Style scoring — verbatim port of the webapp's
 * src/app/utils/teachingStyleScoring.ts. Tightly coupled to the exact
 * question IDs in src/data/teachingStyleQuestions.ts — do not reorder.
 */

export interface TeachingStyleScore {
  primaryStyle: string;
...
export const calculateTeachingStyleScore = (responses: number[]): TeachingStyleScore => {
