/**
 * Adult Thinking Styles Assessment scoring (Ages 19+) — verbatim port of
 * the webapp's src/app/utils/adultScoring.ts.
 */
import { adultQuestions } from '../data/adultThinkingQuestions';
import { careerPaths, CareerPath } from '../data/adultThinkingCareers';
