/**
 * SHS Thinking Styles Assessment scoring (Ages 15-18) — verbatim port of
 * the webapp's src/app/utils/shsScoring.ts.
 */
import { shsQuestions } from '../data/shsThinkingQuestions';
import { tertiaryPrograms, TertiaryProgram } from '../data/shsThinkingPrograms';
